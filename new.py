...
p1 = [50.86490009711029, 488.5019440427165]
p2 = [168.8472552369612, 404.531185997031]
p3 = [104.59226530939249, 130.80574301318114]
p4 = [325.6040590125257, 363.79693958954647]
p5 = [332.3687992146307, 421.9295090851023]
...
while not crashed:
	...
	for i in range(num_play):
		if neigh[i][1] == num_play-1:
			...
			##################    DIST*(K*PERI+(1-K)*CENT)/AREA ALGORITHM    ################
			k=0.65
			...
			if i!=0 and i!=num_play-1:
				...
				nu = ((k*(points[neigh[i][1]][1]-points[neigh[i+1][1]][1])/dn + (points[neigh[i][1]][1]-points[neigh[i-1][1]][1])/dp) + (1-k)*(centy-points[num_play-1][1])/(num_play*dc))/f + (points[neigh[i][1]][1]-points[num_play-1][1])/(d**2) + (points[neigh[i+1][1]][0]-points[neigh[i-1][1]][0])/(2*area)
				de = ((k*(points[neigh[i][1]][0]-points[neigh[i+1][1]][0])/dn + (points[neigh[i][1]][0]-points[neigh[i-1][1]][0])/dp) + (1-k)*(centx-points[num_play-1][0])/(num_play*dc))/f + (points[neigh[i][1]][0]-points[num_play-1][0])/(d**2) - (points[neigh[i+1][1]][1]-points[neigh[i-1][1]][1])/(2*area)
				beta = atan2(nu,de)
				...
				dp = dist(points[neigh[i][1]],points[neigh[i-1][1]])
				nu = ((k*(points[neigh[i][1]][1]-points[neigh[0][1]][1])/dn + (points[neigh[i][1]][1]-points[neigh[i-1][1]][1])/dp) + (1-k)*(centy-points[num_play-1][1])/(num_play*dc))/f + (points[neigh[i][1]][1]-points[num_play-1][1])/(d**2) + (points[neigh[0][1]][0]-points[neigh[i-1][1]][0])/(2*area)
				de = ((k*(points[neigh[i][1]][0]-points[neigh[0][1]][0])/dn + (points[neigh[i][1]][0]-points[neigh[i-1][1]][0])/dp) + (1-k)*(centx-points[num_play-1][0])/(num_play*dc))/f + (points[neigh[i][1]][0]-points[num_play-1][0])/(d**2) - (points[neigh[0][1]][1]-points[neigh[i-1][1]][1])/(2*area)
				beta = atan2(nu,de)
				...
				nu = ((k*(points[neigh[i][1]][1]-points[neigh[i+1][1]][1])/dn + (points[neigh[i][1]][1]-points[neigh[num_play-1][1]][1])/dp) + (1-k)*(centy-points[num_play-1][1])/(num_play*dc))/f + (points[neigh[i][1]][1]-points[num_play-1][1])/(d**2) + (points[neigh[i+1][1]][0]-points[neigh[num_play-1][1]][0])/(2*area)
				de = ((k*(points[neigh[i][1]][0]-points[neigh[i+1][1]][0])/dn + (points[neigh[i][1]][0]-points[neigh[num_play-1][1]][0])/dp) + (1-k)*(centx-points[num_play-1][0])/(num_play*dc))/f + (points[neigh[i][1]][0]-points[num_play-1][0])/(d**2) - (points[neigh[i+1][1]][1]-points[neigh[num_play-1][1]][1])/(2*area)
				beta = atan2(nu,de)
